...
<div class="row g-4 mb-5">
    <div class="col-md-3">
        <div class="card border-0 shadow-sm p-3 text-center transition-hover">
            <div class="text-primary fs-1 mb-2"><i class="bi bi-briefcase"></i></div>
            <h3 class="fw-bold m-0">{{ $serviceCount }}</h3>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm p-3 text-center transition-hover">
            ...
            <h3 class="fw-bold m-0">{{ $projectCount }}</h3>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm p-3 text-center transition-hover">
            ...
            <div class="small fw-bold text-truncate px-2">{{ $company->name ?? 'Not Set' }}</div>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm p-3 text-center transition-hover">
            ...
            <div class="small fw-bold text-truncate px-2">{{ $contact->email ?? 'Not Set' }}</div>
        ...
        <div class="card border-0 shadow-sm bg-brand-primary text-white overflow-hidden p-4">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0 text-white-50">Quickly jump to the sections you want to modify using the sidebar or the buttons below.</p>
                </div>
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <a href="{{ route('admin.projects.create') }}" class="btn btn-light fw-bold px-4 py-2 me-2">AD NEW PROJECT</a>
